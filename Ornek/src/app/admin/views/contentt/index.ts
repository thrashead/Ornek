...
export class AdminContentTIndexComponent implements OnInit, OnDestroy {
	errorMsg: string;
	ContentTList: any;
	...
	constructor(private service: ContentTService, private router: Router) {
	}
