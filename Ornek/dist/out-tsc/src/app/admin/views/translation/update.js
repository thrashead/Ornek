...
let AdminTranslationUpdateComponent = class AdminTranslationUpdateComponent {
    constructor(service, formBuilder, router, route, serviceCategoryT, serviceContentT) {
...
AdminTranslationUpdateComponent = tslib_1.__decorate([
    Component({
        templateUrl: './update.html'
    })
], AdminTranslationUpdateComponent);
export { AdminTranslationUpdateComponent };
